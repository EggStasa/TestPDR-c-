...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        void turn_state(object sender, EventArgs e)
        {
          
            button1.Enabled = true; button1.Focus();
            RadioButton turn = (RadioButton)sender;
            var tmp = turn.Name;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (button1.Text == "Почати тест з початку")
            {
            ...
            if (button1.Text == "Завершити")
            {
                ...
                label1.Text = String.Format("Тест завершено.\n" +
                    "Правильний відповідей: {0} из {1}.\n" +
                    "Набрані бали: {2:F2}.", correct_answers,
                    quection_count, (correct_answers * 5.0F) / quection_count);
              
                button1.Text = "Почати тест спочатку";
            ...
            if (button1.Text == "Наступне питання") answer();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            radioButton1.CheckedChanged += new EventHandler(turn_state);
            radioButton2.CheckedChanged += new EventHandler(turn_state);
            radioButton3.CheckedChanged += new EventHandler(turn_state);
            start();
